...
import ww.mlkit.eyeblink.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.buttonRotation.setOnClickListener{ flipCamera() }
         viewBinding.buttonFlash.setOnClickListener{changeflash()}
                ...
                .addOnSuccessListener {
                    ...
                    faces.forEach { face ->
                        if (face.leftEyeOpenProbability!!< 0.4 || face.rightEyeOpenProbability!! < 0.4) {
                            viewBinding.eyes.text="BLINK"
                            Log.e("debug", "BLINK")
                        } else {
                            viewBinding.eyes.text="DOES NO BLINK"
